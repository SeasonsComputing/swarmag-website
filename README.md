...
The swarmAg website is a modern, single-page web application built for a North Texas ag services company.
The application showcases drone spraying/spreading services and mesquite & brush mitigation treatments,
featuring interactive photo galleries, contact forms, and an engaging bee swarm animation system.
...
:root {
  /* Colors - Fundamental */
  --sa-color-dark: #57534e;
  --sa-color-darker: #1c1917;
  --sa-color-white: #fcfcfc;
  --sa-color-bright: #ffffff;

  /* Colors - Primary */
  --sa-color-green: #95ac63;
  --sa-color-orange: #dcab4f;
  --sa-color-eggshell: #fffcf3;
  --sa-color-mint: #f0fdf4;
  --sa-color-sky: #cdeaff;

  /* Colors - Other */
  --sa-color-border: #e5e7eb;
  --sa-color-divider: #57534e;
  --sa-color-placeholder: #9ca3af;
  ...
  /* Shadows */
  --sa-shadow-hard: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.35);
  --sa-shadow-soft: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);
  --sa-shadow-press: 0 6px 12px rgba(0, 0, 0, 0.3), 0 3px 6px rgba(0, 0, 0, 0.2);
  --sa-shadow-text: 0 0 1px rgba(255, 255, 255, 0.15);
  --sa-shadow-focus: 0 0 0 2px rgba(34, 197, 94, 0.5);
}
```
...
- **Utility-first approach** for smaller download size
